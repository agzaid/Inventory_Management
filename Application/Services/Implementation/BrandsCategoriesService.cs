...
{
    public class BrandsCategoriesService : IBrandsCategoriesService
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ILogger<BrandsCategoriesService> _logger;  // Inject ILogger<BrandService>

        public BrandsCategoriesService(IUnitOfWork unitOfWork, ILogger<BrandsCategoriesService> logger)
        {
            _unitOfWork = unitOfWork;
            _logger = logger;  // Initialize the logger
        }

        public async Task<IEnumerable<BrandsCategoriesVM>> GetAllBrandsCategories()
        {
            try
            {
                var brandsCategories = await _unitOfWork.BrandsCategories.GetAllAsync(s => s.IsDeleted == false);
                var showBrands = brandsCategories.Select(s => new BrandsCategoriesVM()
                {
                    BrandId = s.BrandId,
        ...
        //        {
        //            brand.BrandsCategories = obj.CategoryIds.Select(brandId => new BrandsCategories
        //            {
        //                BrandId = brandId
        //            }).ToList();
        //        }
        ...
        //            if (obj.CategoryIds != null && obj.CategoryIds.Any())
        //            {
        //                oldBrand.BrandsCategories = obj.CategoryIds.Select(brandId => new BrandsCategories
        //                {
        //                    BrandId = brandId
        //                }).ToList();
        //            }
